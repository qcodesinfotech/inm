                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="mobileaddbanner" method="POST" enctype="multipart/form-data">
                                            @csrf                                     
    ...
    <div class="modal fade" id="editexampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="mobilebannerupdate" method="POST" enctype="multipart/form-data">
                    @csrf                                     
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">banner Name</label>
                                ...
                                <div class="table-responsive my-3">
                                 ...
                                 @foreach ($banner as $item)
                                                ...
                                                <td class="cell">
                                                    ...
                                                    <form action="{{ route('mobilebannerdelete', $item->id) }}"
